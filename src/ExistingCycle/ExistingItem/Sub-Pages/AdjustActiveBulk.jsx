  ...
  async function formSubmit(e) {
    ...
    try {
      if (finalArr.length > 0) {
        ...
        // const response = await axios.post(`${API_URL}/update-active`, finalArr);
        ...
        if (mockResponse) {
          swal({
            title: "Status updated successfully (Static Mode)",
            icon: "success",
            button: false,
            timer: 1500,
          });
...
const response = await axios.post(`${API_URL}/update-active", finalArr); - sends a POST request to the specified API endpoint with the finalArr array as the request body, and waits for the response.

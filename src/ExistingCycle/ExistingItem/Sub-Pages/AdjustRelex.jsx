...
const AdjustRelex = () => {
  ...
  async function formSubmit(e) {
    ...
    try {
      ...
      // let responseDetails = await axios.post(`${API_URL}/update-relex`, relexState.relexData);
      // if (relexState.relexAssortment.length > 0) {
      //   let response = await axios.post(`${API_URL}/update-location`, relexState.relexAssortment);
      // }
      ...
      setIsLoading(false);
      swal({
        text: "Relex Data updated successfully (Static Mode)",
        icon: "success",
        button: false,
        timer: 1200,
      });

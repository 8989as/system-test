...
const AdjustActiveItems = () => {
  ...
  function updateInput(e) {
    ...
    if (e.target.name == "inactive")
      setPostLog((prev) => {
        return {
          ...prev,
          action: `${user.name} changed the item ${Id} status to ${e.target.value == "0" ? "Active" : "InActive"
            }`,
        };
      });
  }
  ...
  async function formSubmit(e) {
    ...
    try {
      ...
      // let response = await axios.post(`${API_URL}/update-active`, [activeState.activeData]);

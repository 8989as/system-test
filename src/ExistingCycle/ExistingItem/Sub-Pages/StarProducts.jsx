...
const StarProducts = () => {
  ...
  const mockItems = [
    { ID: 1, Description: "Sample Product 1", ItemLookupCode: "SP001" },
    { ID: 2, Description: "Sample Product 2", ItemLookupCode: "SP002" },
    { ID: 3, Description: "Sample Product 3", ItemLookupCode: "SP003" },
    { ID: 4, Description: "Sample Product 4", ItemLookupCode: "SP004" },
    { ID: 5, Description: "Sample Product 5", ItemLookupCode: "SP005" }
  ];
  ...
  useEffect(() => {
    async function getAllData() {
      try {
        ...
        // let tableRes = await axios.get(`${API_URL}/itemz`);

        // Simulate API delay
        await new Promise(resolve => setTimeout(resolve, 500));

        setIsTableLoading(false);
        setTableData(mockItems);
        const productData = mockItems;
  ...
  async function removeItem(id) {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/remove-star/${id}`, {
        method: 'POST'
      });
  ...
  const updatePoints = async (id) => {
    try {
      await axios.put(`${API_URL}/update-star/${id}`, { extra_points: points[id] });
      swal({

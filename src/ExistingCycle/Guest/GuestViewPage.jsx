...
const GuestViewPage = () => {
  ...
  const mockProduct = {
    ...
    Price: "35.99",
    SubDescription1: "Ambient",
    SubDescription2: "30",
    EnName: "Sample Product",
    ArName: "منتج عينة",
    EnDesc: "This is a sample product description in English",
    ArDesc: "هذا وصف منتج عينة باللغة العربية",
    EnIngredients: "Sample ingredients in English",
    ArIngredients: "مكونات عينة باللغة العربية"
  };
  ...
  async function getTheProduct() {
    try {
      ...
      setImagesView(mockPhotos);
      setState({ ...state, loading: false, products: [mockProduct] });
    } catch (error) {

...
const KVIScreenMain = () => {
    ...
    const handleFileChange = (event) => {
        ...
        reader.onload = (e) => {
            ...
            let validateFun = async () => {
                let res = await axios.get(`${API_URL}/kvi-validation`, { params: [...fileData] });
        ...
        },
        {
            ...
            renderCell: (params) => {
                const onClick = async (e) => {
                    ...
                    let res = await axios.put(`${API_URL}/remove-kvi/${params.row.ItemID}`);
    ...
    const getData = async () => {
        const res = await axios.get(`${API_URL}/kvi-items`);
        console.log(res)
    ...
    const uploadBulkKvisHandler = async () => {
        ...
        try {
            let res = await axios.post(`${API_URL}/add-kvi`, validatedExcelData);

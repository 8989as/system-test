...
const AssortmentUpdate = () => {
  ...
  const getDepartment = useCallback(async () => {
    try {
      ...
      setCostValue(mockProductData[0].Cost);
      setVatValue(mockProductData[0].salestax);
      setSellingValue(mockProductData[0].RetailPrice);
      setProductInfo((p) => {
        return {
          ...p,
          loading: false,
  ...
  // Hardcoded mock categories for static app
  ...
  async function formSubmit(e) {
    ...
    try {
      // API calls commented out for static app
      // let response = await axios.post(`${API_URL}/edit-planning`, existProduct[0]);
      ...
      if (mockResponse) {
        ...
        swal({
          title: `Hi ${user.name}`,
          text: "Product has been Updated (Static Mode)",
          icon: "success",
          button: false,
          timer: 1800,
        });

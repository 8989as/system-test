...
const Xproduct = () => {
    ...
    // Hardcoded mock items data for static app
    const mockExItems = [
        { ID: 1, Description: "Sample Ex Product 1", ItemLookupCode: "EX001" },
        { ID: 2, Description: "Sample Ex Product 2", ItemLookupCode: "EX002" },
        { ID: 3, Description: "Sample Ex Product 3", ItemLookupCode: "EX003" },
        { ID: 4, Description: "Sample Ex Product 4", ItemLookupCode: "EX004" },
        { ID: 5, Description: "Sample Ex Product 5", ItemLookupCode: "EX005" }
    ];

    //Get ALL ITEMS - MODIFIED FOR STATIC APP
    useEffect(() => {
        async function getAllData() {
            try {
                ...
                // let tableRes = await axios.get(`${API_URL}/ex-itemz`);
                ...
                setTableData(mockExItems);
                const productData = mockExItems;
    ...
    const handleFile = async (e) => {
        ...
        reader.onload = function (e) {
            ...
            const validationFun = async () => {
                let res = await axios.get(`${API_URL}/ex-validation`, {
                    params: [...finalData]
                })
    ...
    async function formSubmit(e) {
        ...
        try {
            if (validateData.length > 0) {
                // API call commented out for static app
                // const response = await axios.post(`${API_URL}/add-bulkexitem`, [...validateData]);
                ...
                if (mockResponse.data.message) {
                    swal({
                        title: "Products updated successfully (Static Mode)",
                        icon: "success",
                        button: false,
                        timer: 3000,
                    });
    ...
    // Hardcoded mock selected items for static app
    const mockSelectedItems = [
        { id: 1, ItemLookupCode: "EX001", Description: "Selected Ex Product 1" },
        { id: 2, ItemLookupCode: "EX002", Description: "Selected Ex Product 2" },
        { id: 3, ItemLookupCode: "EX003", Description: "Selected Ex Product 3" }
    ];

    // MODIFIED FOR STATIC APP
    const fetchItems = async () => {
        // API call commented out for static app
        // const response = await axios.get(`${API_URL}/all-exitems`);
        ...
        console.log('modeSelected', mockSelectedItems)
    ...
    async function removeItem(id) {
        ...
        try {
            // API call commented out for static app
            // const response = await fetch(`${API_URL}/remove-exitem/${id}`, { method: 'POST' });
            ...
            // Simulate successful response
            const mockData = { message: 'Item removed successfully' };

            console.log('removing res===>', mockData)
            console.log('data ', mockData)

            if (mockData.message.includes('successfully')) {
                fetchItems()
                swal({
                    text: 'Item removed successfully (Static Mode)',
                    icon: 'success',
                    button: false,
                    timer: 1200,
                });

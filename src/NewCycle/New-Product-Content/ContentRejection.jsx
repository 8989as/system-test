  ...
  const mockRejectedContent = [
    {
      id: 1,
      lookupcode: "CR001",
      description: "Sample Rejected Content 1",
      cRejected: 1,
    ...
    },
    {
      id: 2,
      lookupcode: "CR002",
      description: "Sample Rejected Content 2",
      cRejected: 1,
    ...
    },
    {
      id: 3,
      lookupcode: "CR003",
      description: "Sample Rejected Content 3",
      cRejected: 1,
  ...
  useEffect(() => {
    async function getContentQueue() {
      try {
        ...
        setRejectionQueue(mockRejectedContent);

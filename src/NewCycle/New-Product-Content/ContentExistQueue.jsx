...
const ContentExistQueue = () => {
  ...
  const mockExistingQueue = [
    {
      id: 1,
      ItemLookupCode: "EQ001",
      Description: "Sample Existing Queue Product 1"
    },
    {
      id: 2,
      ItemLookupCode: "EQ002",
      Description: "Sample Existing Queue Product 2"
    },
    {
      id: 3,
      ItemLookupCode: "EQ003",
      Description: "Sample Existing Queue Product 3"
    }
  ];
  ...
  useEffect(() => {
    async function getContentQueue() {
      try {
        ...
        // let responseData = await axios.get(`${API_URL}/web-q`);
        // console.log(responseData);

        // Simulate API delay
        await new Promise(resolve => setTimeout(resolve, 500));

        setContentQueue(mockExistingQueue);

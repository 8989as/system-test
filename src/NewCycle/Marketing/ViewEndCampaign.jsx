...
const ViewEndCampaign = () => {
  ...
  const mockProductData = [
    {
      id: 1,
      ItemLookupCode: Id,
      Description: "Sample Campaign Product",
      Price: "35.99"
    }
  ];
  ...
  const mockCampaignItems = [
    { id: 1, campaign_id: Id, product_id: 1, lookupcode: "SP001" },
    { id: 2, campaign_id: Id, product_id: 2, lookupcode: "SP002" }
  ];
